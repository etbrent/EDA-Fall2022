...
durham_temps <- data.frame(temp_high, temp_high_C_2, temp_low, temp_low_C_2)
colnames(durham_temps) <- c("High (F)", "High (C)", "Low (F)", "Low (C)")
rownames(durham_temps) <- c("09/21", "09/22", "09/23", "09/24", "09/25", "09/26", "09/27", "09/28", "09/29", "09/30")
durham_temps
