...
wind_energy <- read.csv(
  ...
  group_by(HUC_8) %>%
  summarize(sum_kWh = sum(kWhkm2day))


#Join to HUC_8 features
HUC8_join <- HUC %>% 
  left_join(wind_energy, by = "HUC_8") ##not sure what to do here
...
mapview(triangle_counties) +
  mapview(triangle_intersect, alpha.regions = 0)
...
mapview (triangle_counties, color="red")+
