...
withdrawal_plot <- ggplot(data=local_water_df, aes(x=Month, y=Daily_Max_Withdrawals, group=1)) +
  geom_line() +
  geom_smooth(color="tomato", se=F) ##include smoothed line???
...
Durham_Asheville_plot <- ggplot() +
  geom_line(data=Durham_2015, aes(x=Month, y=Daily_Max_Withdrawals, group=1)) +
  geom_line(data=Asheville_2015, color="purple", aes(x=Month, y=Daily_Max_Withdrawals, group=1)) 
