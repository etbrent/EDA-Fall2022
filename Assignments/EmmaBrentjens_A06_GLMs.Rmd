...
temp_model_AIC <- step(temp_model)
...
temp_aov <- aov(data=NTL_LTER_Jul, temperature_C ~ lakename)
summary(temp_aov)

##July temperatures lm
temp_lm <- lm(data=NTL_LTER_Jul, temperature_C ~ lakename)
summary(temp_lm)
...
lake_temp_groups <- HSD.test(temp_aov, "lakename", group = TRUE)
lake_temp_groups
